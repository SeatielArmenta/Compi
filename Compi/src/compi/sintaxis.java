...
public class sintaxis {
        ...
        if (p.token == 201) {
            ...
            if (p.token == 117) {
                ...
                if (p.token == 100) {
                    ...
                    if (existeVariable(p)) {
                        intermedio += "IMPRIMIR " + p.lexema + " " + comprobarImpresion(p) + "\n";
                        p = p.sig;
    ...
    private String comprobarImpresion(nodo p) {
        TablaSimbolos s;
        s = cabezaVariables;
        String tipo = "";
        do {
        ...
        if (evDirecta) {
                ...
                if (s.nombre.equals(evaluada)) {
                    if (comprobarLongitud(s)) {
                        ...
                        if (s.tipo.equals("string")) {
                            intermedio += "ASIGNAR " + s.nombre + " " + valorTemp + " " + s.tipo + "\n";
                        } else {
            ...
            while (s != null) {
                if (s.nombre.equals(evaluada)) {
                    ...
                    intermedio += "ASIGNAR " + s.nombre + " t" + (tempCount - 1) + "\n";
                }
                s = s.siguiente;
            }
        }
